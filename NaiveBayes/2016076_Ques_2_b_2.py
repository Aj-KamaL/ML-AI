...
for i in range (0,5):
    ...
    ab=[]
    if(i<4):
        for j in range (1356*i,1356*(i+1)):
            aa.append(one_f[j])
            ab.append(one_l[j])
        for j in range (1162*i,1162*(i+1)):
            aa.append(et_f[j])
            ab.append(et_l[j])
        folds_f.append(aa)
        fold_l.append(ab)
    else:
        for j in range (1356*i,len(one_l)):
            aa.append(one_f[j])
            ab.append(one_l[j])
        for j in range (1162*i,len(et_l)):
            aa.append(et_f[j])
            ab.append(et_l[j])
        folds_f.append(aa)
        fold_l.append(ab)
...
threshold=[0.41,0.42,0.43,0.45,0.475,0.48,0.49,0.5,0.52,0.55,0.56,0.6,0.7]
